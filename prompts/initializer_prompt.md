...
Never remove features, never edit descriptions, never modify testing steps. Screenshots
can be updated if there are actual screenshot files to be linked to.
